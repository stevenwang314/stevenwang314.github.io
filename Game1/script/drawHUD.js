function drawGameOverHUD(x,y,width,height) {
 ...
 if (getplayer.isAlive() === false) {
    ...
    drawText(x, y+64, "Stage: " + currentStage.toLocaleString("en-US"), "Yanone Kaffeesatz", 24, "black");
    drawText(x, y+64+32, "Score: " + score.toLocaleString("en-US"), "Yanone Kaffeesatz", 24, "black");
    ...
    drawText(x, y+64+32+32, stringData, "Yanone Kaffeesatz", 14, "black");
    ...
    drawText(x, y+64+32+46, stringData, "Yanone Kaffeesatz", 14, "black");
    ...
    drawText(x, y+64+32+60, stringData, "Ubuntu", 14, "black");
    fillRectangle(x+160, y+height-64, 160, 64, "red", 0.5);
    drawRectangle(x+160, y+height-64, 160, 64, "black", 2);
    drawText(x+160, y+height-64, "Play Again!", "Ubuntu", 24, "black");
}
}